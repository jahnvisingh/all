...
<form action="signin1.php" method="POST" id="enter">
   USERNAME:<br><input type="text" name="username" id="username" ><br><span class="text-danger"><?php echo $usererror; ?></span><br>
   PASSWORD:<br><input type="password" name="password1" id="password"><br><span class="text-danger"><?php echo $passError; ?></span><br>
