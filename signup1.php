...
<div id="img"><img src="user.png" height="100px" /></div>
  ...
  <form action="signup1.php" method="POST" id="f1">
     FIRST-NAME:<br><input type="text" name="first" placeholder="*"><br><span class="text-danger"><?php echo $fnameError; ?></span><br>
     LAST-NAME:<br><input type="text" name="last" placeholder="*"><br><span class="text-danger"><?php echo $lnameError; ?></span><br>
     USERNAME:<br><input type="text" name="username" placeholder="*"><br> <span class="text-danger"><?php echo $usererror; ?></span><br>
     EMAIL:<br><input type="text" name="email" placeholder="abc@xyz.com"><br> <span class="text-danger" ><?php echo $emailError; ?></span><br>
     PASSWORD:<br><input type="password" name="password1" placeholder="*"><br><span class="text-danger"><?php echo $passError; ?></span><br>
     RE-PASSWORD:<br><input type="password" name="password2" placeholder="*"><br>
